...
const RidePopUp = (props) => {
  return (
    <div>
      ...
      <h3 className="font-bold text-lg mb-5">New Ride</h3>
     ...
     <div>
      ...
      }} className="text-white font-semibold mt-5 p-2 rounded-xl w-full bg-black">
        Accept
      </button>
       <button onClick={()=>{
            props.setRidePopUpPanel(false);
      }} className="text-black font-semibold mt-2 p-2 rounded-xl w-full bg-gray-400">
        Ignore
      </button>
     </div>
    </div>
