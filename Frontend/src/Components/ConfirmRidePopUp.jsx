...
const ConfirmRidePopUp = (props) => {
    ...
    const handleAcceptRide = async () => {
        ...
        try {
            ...
            // If already accepted, just navigate anyway
            if (error.response?.status === 409) {
                console.log('⚠️ Ride already accepted, navigating anyway...');
                props.setConfirmRidePopUpPanel(false);
                setTimeout(() => {
                    navigate('/captain-riding', { state: { ride: props.ride } });
                }, 500);
            ...
            <div className="relative">
                ...
                <div className="pt-8">
                    ...
                    <div>
                        ...
                        <div>
                            {error && (
                                <div className="mt-3 p-3 bg-red-100 text-red-700 rounded-lg text-sm">{error}</div>
                            )}
